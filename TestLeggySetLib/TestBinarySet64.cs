...
namespace TestLeggySetLib
{
    ...
    public class TestBinarySet64
    {
        ...
        public void TestInitBadRange(int min, int max)
        {
            ...
            {
                ISet<int> mySet = new BinarySet64(min,max);
            });
        ...
        {
            ISet<int> mySet = new BinarySet64(1, 32);
        ...
        {
            ISet<int> mySet = new BinarySet64(minNum, maxNum);
        ...
        public void TestIsFasterThanHashSet()
        {
            ...
            {
                binStopWatch.Start();
                ISet<int> binSet = new BinarySet64(1, 32);
            ...
            string message = String.Format("HashSet took {0} microseconds. BinarySet64 took {1} microseconds.",
        ...
        {
            ISet<int> binSet = new BinarySet64(1, 3) { 1, 2 };
        ...
        {
            ISet<int> binSet = new BinarySet64(1, 10);
            binSet.UnionWith(GetIntArrFromArrString(arr1String));
        ...
        {
            ISet<int> binSet = new BinarySet64(minNumber, maxNumber);
